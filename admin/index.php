                ...
                if($Joueur1->isAdmin() == true){
                    ?>
                        ...
                        <div class='Div1 BG_Cyan'>
                            ...
                            <p class='TC'><a href=''>Accéder au panel de Modification des Utilisateurs.</a></p>
                        </div>
                        <div class='Div1 BG_Rouge'>
                            <h3 class='TC'>Modification Personnages</h3>
                            <p class='TC'><a href=''>Accéder au panel de Modification des Personnages.</a></p>
                        </div>
                        <div class='Div1 BG_Bleu'>
                            <h3 class='TC'>Modification Monstres</h3>
                            <p class='TC'><a href=''>Accéder au panel de Modification des Monstres.</a></p>
                        </div>
                        <div class='Div1 BG_Jaune'>
                            <h3 class='TC'>Modification Map</h3>
                            <p class='TC'><a href=''>Accéder au panel de Modification de la Map.</a></p>
                        </div>
                        <div class='Div1 BG_Vert'>
                            <h3 class='TC'>Modification Items</h3>
                            <p class='TC'><a href=''>Accéder au panel de Modification des Items.</a></p>
                        </div>
                    <?php
                }else{

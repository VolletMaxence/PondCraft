        ...
        <?php 
            ...
            if($affichSud){
                ...
                if(!is_null($Msud)){
                    ...
                    ?>
                    Sud : y-1 <div class="MapAdjacenteSud"><a href="map.php?position=Generate&cardinalite=nord">Découvre cette Région Inconnue.</a></div>
                    <?php
                }
                echo '</div>';
            }
            ...
            if($affichNord){
                ...
                if(!is_null($Mnord)){
                    ...
                    ?>
                    Nord : y+1<div class="MapAdjacenteNord"><a href="map.php?position=Generate&cardinalite=sud">Découvre cette Région Inconnue.</a></div>
                    <?php
                }
                echo '</div>';
            }
            ...
            if($affichEst){
                ...
                if(!is_null($Mest)){
                    ...
                    ?>
                    Est : x+1<div class="MapAdjacenteEst"><a href="map.php?position=Generate&cardinalite=ouest">Découvre cette Région Inconnue.</a></div>
                    <?php
                }
                echo '</div>';
            }
            ...
            if($affichOuest){
                ...
                if(!is_null($Mouest)){
                    ...
                    ?>
                    Ouest : x-1<div class="MapAdjacenteOuest"><a href="map.php?position=Generate&cardinalite=est">Découvre cette Région Inconnue.</a></div>
                    <?php
                }
                echo '</div>';
            }

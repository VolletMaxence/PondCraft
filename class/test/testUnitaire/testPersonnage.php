...
echo "<div><p>Test 1 Lecture d'un Personnage  </p>";
...
echo "<div><p>Test 2 Lecture d'un Personnage de type Perso </p>";
...
echo "<div><p>Test 2 création d'un Personnage de type Perso </p>";
